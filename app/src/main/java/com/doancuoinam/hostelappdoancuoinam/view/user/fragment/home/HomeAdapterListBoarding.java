...
public class HomeAdapterListBoarding extends RecyclerView.Adapter<HomeAdapterListBoarding.HomeViewHolder>{
    ...
    @NonNull
    @Override
    public HomeAdapterListBoarding.HomeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_places_near, parent, false);
        return new HomeViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HomeAdapterListBoarding.HomeViewHolder holder, int position) {
